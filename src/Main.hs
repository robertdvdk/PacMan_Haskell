...
main = do
    ...
    let initialGhosts2 = [Ghost redGhostBM (-22, -20) West East InsideCage 0, Ghost blueGhostBM (-22, -21) West West InsideCage 3]
    let initialLevel2 = Level green maze2 cage2 initialGhosts2 food2 largefood2 playerSpawn2 0

    let playerSpawn3 = (0, 0)
    let initialGhosts3 = [Ghost redGhostBM (22, 3) West West InsideCage 0, Ghost blueGhostBM (21, 2) West West InsideCage 1, 
    ...
    let initialState = GameState Start initialPlayer initialLevel1 [initialLevel1, initialLevel2, initialLevel3] 0 highScores
